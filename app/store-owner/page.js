...
export default function StoreOwner() {
    ...
    const handleSubmitNewTopping = async (e) => {
        ...
        const res = await fetch("http://127.0.0.1:8000/toppings/create/", {
            method: 'POST',
            headers: {
    ...
    const handleEditSubmit = async (e) => {
        ...
        const res = await fetch("http://127.0.0.1:8000/toppings/update/", {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json',
              },          
    ...
    const handleDelete = async (e, toppingName) => {
        try {
            const res = await fetch("http://localhost:8000/toppings/delete/", {
              method: "DELETE",
              headers: {
                "Content-Type": "application/json",
              },
